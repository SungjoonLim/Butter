...
//		System.out.println(pagination.toString());
	...
	public String thumb(@PathVariable int imageId, Model model)
						throws Exception{
		Image image = service.getImage(imageId);
		String path = ImageService.THUMB_DIR+"/"+
						image.getThumbName();
	...
	public String image(@PathVariable int imageId, Model model)
						throws Exception{
		Image image = service.getImage(imageId);
		String path = ImageService.IMAGE_DIR+"/"+
						image.getNewName();
		model.addAttribute("type",image.getMimeType());
		model.addAttribute("path",path);
	...
	public String download(@PathVariable int imageId, Model model)
						throws Exception{
		Image image = service.getImage(imageId);
		String path = ImageService.IMAGE_DIR+"/"+
						image.getNewName();
	...
	public String uploadSubmit(@Valid Image image, BindingResult result,
